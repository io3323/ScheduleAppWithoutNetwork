...
class TasksTableViewCell:UITableViewCell{
    let taskName = UILabel(text: "IT", font: .avenirNextDemiBold20(), alignment: .left)
    let taskDescription =  UILabel(text: "work with IT", font: .avenirNext14(), alignment: .left)
    ...
    weak var cellTaskDelegate:PressReadyTakButtonProtocol?
    var index:IndexPath?
    override init(style: UITableViewCell.CellStyle, reuseIdentifier:String?){
        ...
        readyButton.addTarget(self, action: #selector(readyButtonTapped), for: .touchUpOutside)
