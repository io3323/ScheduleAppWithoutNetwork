...
class ScheduleViewController:UIViewController{
    ...
    private let idScheduleCell = "idSceduleCell"
    ...
    private func scheduleOnDay(date:Date){
        ...
        let predicateRepeate = NSPredicate(format: "scheduleWeekday = \(weekday) AND scheduleRepeat = true")
        let predicateUNrepeate = NSPredicate(format: "scheduleRepeat = false AND scheduleDate BETWEEN %@", [dateStart,dateEnd])
        let compound = NSCompoundPredicate(type: .or, subpredicates: [predicateRepeate, predicateUNrepeate])
